...
import { Sparkles, Zap, Crown, Rocket, Check, ArrowRight, ArrowLeft } from 'lucide-react';
import './pricing.css';
...
export default function PricingPage() {
  ...
  useEffect(() => {
    const returnPath = searchParams.get('returnTo') || localStorage.getItem('pricingReturnPath') || '/generate';
  ...
  const tokenPackages = [
    {
      id: 'starter',
      name: 'Starter',
      tokens: 100000, // Actual tokens stored in DB
      displayTokens: '100', // Display value (tokens/1000)
      price: 0,
      icon: Sparkles,
      color: 'blue',
      features: [
        'Generate 2-3 websites',
        'Basic support',
        'Valid forever'
      ],
      popular: false
    },
    {
      id: 'pro',
      name: 'Professional',
      tokens: 500000, // Actual tokens stored in DB
      displayTokens: '500', // Display value (tokens/1000)
      price: 0,
      icon: Zap,
      color: 'purple',
      features: [
        'Generate 10-15 websites',
        'Priority support',
        'Valid forever'
      ],
      popular: true
    },
    {
      id: 'business',
      name: 'Business',
      tokens: 1000000, // Actual tokens stored in DB
      displayTokens: '1000', // Display value (tokens/1000)
      price: 0,
      icon: Crown,
      color: 'gold',
      features: [
        'Generate 30+ websites',
        'Premium support',
        'Valid forever'
      ],
      popular: false
  ...
  const handlePurchase = async (packageData) => {
    ...
    try {
      ...
      setSuccess(`Successfully added ${formatTokenDisplay(packageData.tokens)} tokens to your account!`);
      ...
      <div className="pricing-container">
        ...
        <header className="pricing-header">
          ...
          <p className="pricing-subtitle">
            Get started with AI-powered website generation. Choose a packages suitable for you project needs.
          </p>
        </header>
